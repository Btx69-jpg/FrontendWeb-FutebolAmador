...
export const routes: Routes = [
  ...
  { path: 'team/createMatchInvite/:teamId', component: CreateMatchInvite, canActivate: [AuthGuard], data: { isAdmin: true }},
  { path: 'team/negotiateMatchInvite/:teamId', component: CreateMatchInvite, canActivate: [AuthGuard], data: { isAdmin: true }},
